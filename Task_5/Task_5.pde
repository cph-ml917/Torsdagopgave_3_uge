...
/*
5.a In your tab Datamatik, make a new method called isClassmates(). 
The method should take two Student objects as parameters. The method should return a boolean.
*/
...
Make sure that you assign the returnvalue to a variable in the setup()-method. 
